...
const SCHENGEN_STEPS = [
  ...
  "إنشاء ملفك على منصة منفذ السعادة وتعبئة بياناتك.",
...
function schengenCountry(params: {
  ...
  return {
    ...
    faqs: SCHENGEN_FAQS,
    importantNotesAr: [
      "الرسوم الحكومية تُدفع مباشرة للسفارة أو مركز التقديم المعتمد وليست جزءًا من رسوم منصة منفذ السعادة.",
...
export const COUNTRIES: CountryVisaInfo[] = [
  ...
  // بريطانيا
  {
    ...
    applicationSteps: [
      ...
      "تجهيز ملفك ومستنداتك على منصة منفذ السعادة.",
    ...
    importantNotesAr: [
      "منفذ السعادة لا تُقدّم أي بيانات نيابة عنك لموقع UKVI دون علمك وموافقتك الصريحة.",
  ...
  // أمريكا
  {
    ...
    importantNotesAr: [
      "لا تضمن منصة منفذ السعادة حجز موعد أو قبول الطلب؛ التقديم والمقابلة الشخصية إلزامية أمام الجهة الرسمية.",
